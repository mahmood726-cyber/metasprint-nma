        # Metasprint Nma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metasprint-nma.git

        ## Objective

        MetaSprint NMA extends the MetaSprint pipeline to network meta-analysis, providing automated comparative effectiveness synthesis.
        ...
        - Code: https://github.com/mahmood726-cyber/metasprint-nma.git
        - Dashboard: https://mahmood726-cyber.github.io/metasprint-nma/
